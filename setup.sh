...
#
# 一键运行（复制粘贴到终端）:
#   curl -fsSL https://www.kkpinche.ai/set-thirdparty-api.sh -o /tmp/claw.sh && bash /tmp/claw.sh
#
# 使用 wget（容器/Linux 备选）:
#   wget -qO /tmp/claw.sh https://www.kkpinche.ai/set-thirdparty-api.sh && bash /tmp/claw.sh
